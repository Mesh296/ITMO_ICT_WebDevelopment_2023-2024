            ...
            <div class="border-b-2 block md:flex">
                ...
                <div v-if="!editMode" class="w-full md:w-3/5 p-8 bg-white lg:ml-4 shadow-md">
                    <div class="rounded  shadow p-6">
                        ...
                        <div class="pb-4">
                            <label class="font-semibold text-gray-700 block pb-1">Age</label>
                            <input v-model="profile.age" disabled class="border-1  rounded-r px-4 py-2 w-full" />
                        </div>

                        <div class="pb-4">
                            <label class="font-semibold text-gray-700 block pb-1">Height</label>
                            <input v-model="profile.height" disabled class="border-1  rounded-r px-4 py-2 w-full" />
                        </div>

                        <div class="pb-4">
                            <label class="font-semibold text-gray-700 block pb-1">Weight</label>
